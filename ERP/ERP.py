...
def listarArquivosNaPasta(pasta=DIRETORIOEXERCICIO, extensao=False):
...
3  - LISTAR OS ARQUIVOS [PDF] NA PASTA {DIRETORIOEXERCICIO}
4  - PROCURAR UM ARQUIVO PDF NA PASTA {DIRETORIOEXERCICIO}
...
{LI} ESCOLHA UMA OPÇÃO: """)
    match opcao:
        ...
        case "2":
            ...
            input(f"{LINHAZINHA}\n{LI} Clique ENTER para voltar ao menu\n")
        case "3":
            print(f"{LINHA}\nLISTAR ARQUIVOS PDF NA PASTA {DIRETORIOEXERCICIO.name}")
            listarArquivosNaPasta(pasta=DIRETORIOEXERCICIO, extensao=".pdf")
            input(f"{LINHAZINHA}\n{LI} Clique ENTER para voltar ao menu\n")
        case "4":
            print(f"{LINHA}\nLISTAR ARQUIVOS PDF NA PASTA {DIRETORIOEXERCICIO.name}")
            listarArquivosNaPasta(pasta=DIRETORIOEXERCICIO, extensao=".pdf")
