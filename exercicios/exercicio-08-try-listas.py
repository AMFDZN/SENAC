...
# com a mensagem Idade inválida. Caso contrário, mostre a idade.
            ...
            print("\n--- Exercício 3: Avaliar 5 Números Digitados ---")
            
            somaTotal = 0.0
            entradasValidas = 0
            contadorLoop = 1
            
            # O laço roda até termos processado 5 tentativas do usuário
            while contadorLoop <= 5:
                try:
            ...
            # Cálculo final e exibição após sair do laço
            print("\n--- Resultado Final ---")
            print(f"Quantidade de entradas válidas: {entradasValidas}")
            print(f"Soma total dos números válidos: {somaTotal}")
            
            # Evita divisão por zero se nenhuma entrada foi válida
            if entradasValidas > 0:
                mediaFinal = somaTotal / entradasValidas
                print(f"Média dos números válidos: {mediaFinal}")
            else:
                print("Não foi possível calcular a média (nenhum número válido inserido).")
                ...
                match opcaoListas:
                    ...
                    case "2":
                        if len(listaItens) == 0: #vai que?!
                            ...
                            continue
                        try:
                            print(f"Itens atuais com seus índices:")
