...
def ler_mensagem(driver):
    """
    Localiza e retorna a mensagem exibida
    ...
    aguardar_elemento():
        Aguarda até que o elemento da mensagem
        esteja disponível na página.

    mensagem.text:
        Obtém o texto que está dentro do elemento HTML.

    Retorno:

        str:
            Texto da mensagem encontrada.

        None:
            Caso a mensagem não seja encontrada.
    """
