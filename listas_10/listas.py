...
""")
    ...
    match escolha:
        case "1":
            ...
            print("Última fruta:", frutas[-1]) #último índice
            frutas[1] = "morango" #mudou o valor do índice [1]
            print("Lista após alteração:", frutas)
            frutas.append("abacaxi") #append - final - insere no final da lista
            print("Lista após append:", frutas)
            frutas.remove("laranja") #remove 
            print("Lista após remove:", frutas)
            removido = frutas.pop(0) #remove pelo índice
            print(f"Removido com pop: {removido}")
            print("Lista final:", frutas)

            print("Percorrendo com for índice:")
            for i in range(len(frutas)): #range: percorre a quantidade de elementos lista
                print(f"{i} = {frutas[i]}")
        ...
        case "2":
            ...
            nomes = []
            for i in range(quantidade): #range segue o número informado em "quantidade"
                nome = input(f"Digite o nome {i+1}: ").strip()
                nomes.append(nome) # insere o nome digitado
